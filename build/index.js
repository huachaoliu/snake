...
module.exports = function () {
  function Configuration() {
    ...
    this._wrapper = (0, _utils.facotry)('ctrl_wrapper');
  }

  _createClass(Configuration, [{
    key: 'show',
    value: function show() {
      this._mask = (0, _utils.facotry)('div', 'ctrl_mask');
      this._board = (0, _utils.facotry)('div', 'ctrl_board');
      _utils.addDom.call(this._wrapper, this._mask, this._board);
